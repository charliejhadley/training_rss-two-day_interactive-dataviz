...
> - Lecture slides
>    - These are written in RMarkdown, which is a technology you'll learn how to use in the first day of training. <br>
    You'll be shown how to make the lecture slides work on your machine at the end of the day.
> - Live/group coding
>    - Most of the exercises we'll go through are "live coding exercises", the lecturer will write code that you'll copy to your machine. What we end up building together will be very dependent on what you're interested in as a group.<br>
    At the end of each section the lecturer will provide a download link for the **exact** code on their machines.
> - Exercises
>    - There are a set of exercises in the materials that might be included in the course itself or else you might be encouraged to work on after the course. <br>
